...
const HeroComponent = () => {
  const isMobile = window.innerWidth <= 912;  // Define mobile screen size (you can adjust this)

  return (
    <div style={{
        display: "flex",
        flexDirection: "column",
        alignItems: isMobile ? "center" : "flex-start",  // Mobile centers content, desktop left-aligns
        justifyContent: "center",
        height: "100vh",
        paddingLeft: "12%",
        position: "relative",
        paddingRight: isMobile ? "12%" : "0",  // Adjust padding for mobile and desktop
      ...
      <div style={{ display: "flex", gap: isMobile ? "20px" : "30px", transform: "translateY(60%)" }}>
