    ...
    >
      ...
      >
        <h2 className="text-3xl font-bold mb-4">
          Ready to boost your inventory reach?
        </h2>
        <p className="text-gray-300 mb-6">
          We provide a seamless solution that maximizes the value of your
          screens without the hassle of contacting advertisers or media
          agencies. When a brand&apos;s needs align with your inventory,
          we&apos;ll take care of showing the right ads, helping you earn
          effortlessly while building a trusted partnership.
        </p>
        <button
